        ...
        <div className="info-section">
          ...
          <div className="attributes-grid">
            {(attrFields && attrFields.length > 0
              ...
              <div key={f.field_name} className="attr-item" title={f.field_display_name ? undefined : f.hint}>
                {f.field_display_name ? (
                  <span className="attr-label attr-label--display">
                    {f.field_display_name}
                    <span className="attr-hint-icon" title={f.hint}>?</span>
                  </span>
                ) : (
                  <span className="attr-label">{f.hint}</span>
                )}

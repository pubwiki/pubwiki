...
import type { WBNPhaseId, WBNDraftOutput } from './worldBuilderNextTypes'
                        ...
                        properties: {
                            Creature: {
                                ...
                                properties: {
                                    ...
                                    attrs: { type: 'object', additionalProperties: { oneOf: [{ type: 'number' }, { type: 'string' }] } },
                                    ...
                                    status_effects: {
                                        ...
                                        items: {
                                            ...
                                            properties: {
                                                ...
                                                remark: { type: 'string', description: 'Full description explaining all data fields and their current values (in user\'s language)' },
                                                data: { type: 'object' },
                                            },

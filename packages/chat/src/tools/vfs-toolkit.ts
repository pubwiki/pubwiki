 ...
 */
export function registerVFSTools(registry: ToolRegistry, vfs: Vfs): void {
  // read_file tool
  registry.register(
    'read_file',
    'Read the content of a file at the specified path. Returns the file content as a string.',
    z.object({
  ...
  registry.register(
    'list_dir',
    'List the contents of a directory at the specified path. Returns an array of entries with name and isDirectory flag.',
    z.object({
  ...
  registry.register(
    'rmdir',
    'Remove a directory at the specified path. Use recursive option to remove non-empty directories.',
    z.object({
  ...
  registry.register(
    'file_stat',
    'Get information about a file or directory at the specified path.',
    z.object({
 ...
 */
export function getVFSToolDefinitions(): Array<{
  name: string
  description: string

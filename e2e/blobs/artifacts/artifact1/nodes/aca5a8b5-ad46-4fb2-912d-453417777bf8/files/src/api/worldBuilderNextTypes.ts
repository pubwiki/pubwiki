...
/**
 * Game style determines how world_data and creatures phases generate data:
 * - 'numerical': Stats-driven RPG with precise numeric attributes, custom components, detailed status effects
 * - 'narrative': Story-driven game with minimal/qualitative attributes, text-based state tracking
 */
export type WBNGameStyle = 'numerical' | 'narrative'
...
export interface WBNSession {
    ...
    /** Game style: numerical (stats-driven) or narrative (story-driven) */
    gameStyle?: WBNGameStyle
    /** Skip sub-agent extraction — inject full file/lorebook content directly into the primary model */

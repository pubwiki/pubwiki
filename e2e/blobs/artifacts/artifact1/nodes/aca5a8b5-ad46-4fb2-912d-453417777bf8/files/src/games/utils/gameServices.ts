...
/** Get all plot events from the world entity */
export async function getEvents(): Promise<{ success: boolean; events: EventEntry[] }> {
  return window.callService<{ success: boolean; events: EventEntry[] }>('ecs.system:Events.getEvents', {})
}

    ...
    :impl(function(inputs)
        ...
        local output_schema = {
            ...
            properties = {
                ...
                step_3_gamestate_changes = {
                    type = "object",
                    properties = {
                        related_creature_ids = { type = "array", items = { type = "string" } },
                        related_region_ids = { type = "array", items = { type = "string" } },
                        related_organization_ids = { type = "array", items = { type = "string" } },
                        service_calls = {
                            type = "array",
                            items = {
                                type = "object",
                    ...
                    required = { "related_creature_ids", "related_region_ids", "related_organization_ids", "service_calls" }
                },
                step_4a_setting_update_recommands = {
                    type = "array",
                    items = {
                        type = "object",
                        properties = {
            ...
            required = { "step_1_thinking_result", "step_2_creative_content", "step_3_gamestate_changes", "step_4a_setting_update_recommands", "step_4b_event_recommands", "step_5_director_notes" }
        }
        ...
        if inputs.reuse_last_collect and last_overview_result then
            ...
            if overview_result.collector_results == nil or #overview_result.collector_results == 0 then
                error("RAG collector returned no results")
            end
            ...
            if chunk.type == "token" then
                ...
                inputs.callback({
                    ...
                    event_data = {
                        ...
                        setting_changes = data.step_4a_setting_update_recommands or nil,
                        event_changes = data.step_4b_event_recommands or nil,

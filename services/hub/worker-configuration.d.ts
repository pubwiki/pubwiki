/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ca812d5d5dea63ba5fcdde96c0d2b969)
// Runtime types generated with workerd@1.20260114.0 2025-12-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		BETTER_AUTH_TRUSTED_ORIGINS: "https://pub.wiki,https://api.pub.wiki,https://studio.pub.wiki,https://hub.pub.wiki";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_TRUSTED_ORIGINS" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
